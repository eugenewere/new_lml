# Generated by Django 3.1 on 2020-08-06 13:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('status', models.CharField(choices=[('DEACTIVATED', 'Deactivated'), ('REGISTERED_CONFIRMED', 'Registerd_confirmed'), ('NEWBIE', 'Newbie')], default='NEWBIE', max_length=200)),
                ('rank_status', models.CharField(choices=[('PRO_BASIC', 'Pro_basic'), ('PREMIUM', 'Premium'), ('PRO_ULTIMATE', 'Pro_ultimate'), ('BASIC', 'Basic'), ('UNDEFINED', 'Undefined'), ('ULTIMATE', 'Ultimate'), ('PLATINUM', 'Platinum')], default='UNDEFINED', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delstar', models.CharField(choices=[('DELETE', 'Delete'), ('STARRED', 'Starred'), ('NORMAL', 'Normal')], default='NORMAL', max_length=200)),
                ('labels', models.CharField(blank=True, choices=[('MISC', 'Misc'), ('WORK', 'Work'), ('PRODUCT', 'Product'), ('UNDEFINED', 'Undefined')], default='UNDEFINED', max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('graduation_date', models.DateTimeField(default=datetime.datetime(2020, 8, 6, 16, 17, 55, 960290))),
