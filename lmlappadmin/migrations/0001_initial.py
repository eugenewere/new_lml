    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rank_status', models.CharField(choices=[('PREMIUM', 'Premium'), ('PRO_BASIC', 'Pro_basic'), ('PRO_ULTIMATE', 'Pro_ultimate'), ('ULTIMATE', 'Ultimate'), ('BASIC', 'Basic'), ('PLATINUM', 'Platinum'), ('UNDEFINED', 'Undefined')], default='UNDEFINED', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('status', models.CharField(blank=True, choices=[('TRASH', 'Trash'), ('UNREAD', 'Unread'), ('READ', 'Read')], default='UNREAD', max_length=200, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='County',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipt_no', models.CharField(max_length=200)),
                ('payment_status', models.CharField(choices=[('UNPAYED', 'Unpayed'), ('PAYED', 'Payed'), ('PARTIAL', 'Partial')], default='UNPAYED', max_length=200)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(choices=[('PRODUCT', 'Product'), ('UNDEFINED', 'Undefined'), ('MISC', 'Misc'), ('WORK', 'Work')], default='UNDEFINED', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('graduation_date', models.DateTimeField(default=datetime.datetime(2020, 8, 19, 17, 31, 9, 989394))),
